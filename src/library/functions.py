...
def get_products(api_key , formtype = 'IDF'):
    ...
    items = monday_board.get_items_by_column_values( PRODUCT_BOARD_FORM_TYPE_ID, formtype , return_items_as='json').get('data').get('items_page_by_column_values').get('items')
