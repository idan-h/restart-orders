...
const TextLine = (text: string) => {
    return <div style={{marginTop: '10px', display: 'flex'}}>
...
export const AboutUs = () => {
    ...
    return (
        <div style={{ margin: 'auto' }}>
            ...
            <p>
                <b style={{marginBottom: '10px'}}>פלטפורמה ללא מטרות רווח שמאחדת בין הבקשות בשטח לבין הספקים</b >
                {TextLine("קיבוץ ובקרה של הבקשות בשטח במקום אחד")}
                {TextLine("עבודה משותפת עם עמותות, ספקים ותורמים על מנת ליצור מערכת משותפת של אספקת הציוד לחיילים בצורה היעילה ביותר")}
            ...
            <a href="https://restartglobal.org/home">
                <div><img style={{height: '80px'}} src={Restart} alt="restart"></img></div>
                לאתר עמותת Restart
                </a>
            </p>
            ...
            <p>
                ...
                <div style={{textAlign: 'center', display: 'flex', justifyContent: 'space-between'}}>
                    ...
                    <img style={{height: '60px'}} src={Microsoft} alt="Microsoft"></img>
                </div>
            </p>
        </div>
    );
