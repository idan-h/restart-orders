...
export function makeFakeAuthenticationService(): ReturnType<typeof makeAuthenticationService> {
  let userId: string | undefined = localStorage.getItem("fakeUserId") ?? undefined;
